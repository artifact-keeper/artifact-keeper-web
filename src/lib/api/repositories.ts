...
function adaptRepository(sdk: RepositoryResponse): Repository {
  return {
    ...
    // Package age policy (#265) so the settings form can show the saved config.
    quarantine_enabled: sdk.quarantine_enabled ?? undefined,
    quarantine_duration_minutes: sdk.quarantine_duration_minutes ?? undefined,
